...
<body>
<h1>공지사항 수정</h1>
<form name="form1" action="${pageContext.request.contextPath}/Spring/NoticeModifyActionController" method="post">
...
<table cellpadding=0 cellspacing=1 border=1>
	...
	<tr>
		...
		<td><input type="text" name="notice_writer" value="${notice_idx}"></td>
	</tr>	
