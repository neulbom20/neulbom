...
<body>
<h1>자유게시판 글쓰기</h1>
<form name="form2" action="${pageContext.request.contextPath}/Spring/BoardWriteActionController" method="post">
...
<table cellpadding=0 cellspacing=1 border=1>
	...
	<tr>
		...
		<td><input type="text" name="board_writer" value="${board_id}"></td>
	</tr>	
