...
<script type="text/javascript">
 ...
 function check(){
		...
		if (form0922.photoalbum_title.value =="") {
			alert("제목을 적어주세요");
		    form0922.photoalbum_title.focus();
		    return false;		    
	} 
	//else if (form0922.memo.value ==""){
	//document.getElementById("lblName") .innerHTML = form0922.subject.value;
	//}  
		else if (form0922.photoalbum_content.value =="") {
		alert("내용을 적어주세요");
		form0922.photoalbum_content.focus();
		return false;
		
	}  else if (form0922.photoalbum_writer.value =="") {
		alert("작성자를 입력하세요");
		form0922.photoalbum_writer.focus();
		return false; 
	}
		form0922.submit();
		return;
...
<title>포토앨범 글쓰기</title>
</head>
<body>
<h1>포토앨범 글쓰기</h1>
<form name="form3" action="${pageContext.request.contextPath}/Spring/PhotoAlbumWriteActionController" method="post">
